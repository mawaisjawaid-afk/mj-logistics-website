...
export default function SelectServicePage() {
  ...
  const handleBusinessClick = () => {
    window.location.href = `/business-quote?pickup=${encodeURIComponent(pickup)}&delivery=${encodeURIComponent(delivery)}`;
  };

  const handlePersonalClick = () => {
    window.location.href = `/personal-quote?pickup=${encodeURIComponent(pickup)}&delivery=${encodeURIComponent(delivery)}`;
  };

  return (
    <main className="min-h-screen bg-[#f3f3f3] text-[#111827]">
      
      {/* Top spacing before the red strip */}
      ...
      <div className="w-full bg-red-700 py-3 md:py-4">
        <div className="mx-auto flex w-full max-w-[1376px] items-center justify-between px-5 md:px-6 lg:px-5">
          ...
          {/* Center - Pickup to Delivery (only first word/city name) */}
        ...
        <div className="mx-auto w-full max-w-[1200px]">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-[#6b7280] md:text-base">
              Select business for Full truck or partload or personal for household goods
            </p>
          </div>

          {/* Service Options - No Continue Button, Direct Click Navigation */}
          <div className="mx-auto max-w-[900px]">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              
              {/* Business Card - Click directly navigates */}
              <div
              ...
              {/* Personal Card - Click directly navigates */}
              <div
